...
class BikeInfoTableViewCell: UITableViewCell {
    ...
    static let identifier: String = "BikeInfoTableViewCell"
    ...
    func setupUI () {        
        ...
        NSLayoutConstraint.activate([
            ...
            districtLabel.leadingAnchor.constraint(equalTo: cityLabel.trailingAnchor, constant: 25),
            stationNameLabel.leadingAnchor.constraint(equalTo: districtLabel.trailingAnchor, constant: 22),
...
#Preview(traits: .fixedLayout(width: 311, height: 72), body: {
    let bikeInfoTableViewCell = BikeInfoTableViewCell()
